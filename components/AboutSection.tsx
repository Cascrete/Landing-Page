export default function AboutSection() {
  return (
    <section
      id="about"
      className="flex w-full flex-col items-center justify-center border-b border-[rgba(202,196,211,0.3)] bg-dark-800 pb-[65px] pt-[64px] max-md:py-12"
    >
      <div className="grid w-full max-w-[1360px] grid-cols-12 gap-x-[32px] px-[32px] max-md:grid-cols-1 max-md:px-5">
        ...
        <div className="col-span-8 flex flex-col items-start gap-[16px] self-start max-md:col-span-1">
          ...
          <p className="font-hanken text-[18px] leading-[29.25px] tracking-[-0.09px] text-[#e7deff]">
            Cascrete bridges that gap through clear brand strategy, exacting
